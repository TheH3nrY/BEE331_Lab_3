...
\begin{figure}[hp!]
	\centering
	\subfloat[\centering Gate \& Spice Sim]{{\includegraphics[width=18cm]{Screenshot 2024-08-07 0423451}}}
\end{figure}
...
When measuring the circuit from the above, which we forgot to take oscilloscope screenshots for - we designed the circuit and developed two separate square-waves that reprsented high \& low. $V_{out}$, we had 3 voltmeters set up - and alternated between the truth table values above; $2^2$ values.

\begin{figure}[hp!]
	\centering
	\subfloat[\centering NAND Table]{{\includegraphics[width=18cm]{Screenshot 2024-08-07 060220}}}
\end{figure}
...
\begin{figure}[hp!]
	\centering
	\subfloat[\centering Gate \& Spice Sim]{{\includegraphics[width=18cm]{Screenshot 2024-08-07 042345}}}
\end{figure}

\nsection{Describing}
\emph{Describe your test plan and how you would test the NAND gate with two synchronized function generator channels.}

\begin{figure}[hp!]
	\centering
	\subfloat[\centering NOR Table]{{\includegraphics[width=18cm]{Screenshot 2024-08-07 060220}}}
\end{figure}
...
\end{itemize}
\begin{figure}[!h]
	\subfloat[It didn't get easier. We just got better.]{\includegraphics[width=\linewidth]{__penance_arknights_drawn_by_duya_ehouhouohahaha__c12b4a5221fa078ded1b9fc3ca433f0b}}
\end{figure}
